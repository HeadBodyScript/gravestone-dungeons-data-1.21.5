...
execute as @a[distance=..6] unless score @p ability.link = @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=armor_stand.ability_warp] ability.link run function gd_ability:ability/warp/effect0
...
execute as @s[scores={tick=245}] as @e[type=marker,tag=armor_stand.ability_warp] if score @s ability.link = @e[type=armor_stand,tag=armor_stand.ability_warp,limit=1,sort=nearest] ability.link at @s run function gd_ability:ability/warp/effect1
