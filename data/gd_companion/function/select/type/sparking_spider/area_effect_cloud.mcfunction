...
execute as @s[scores={tick=12}] run summon lightning_bolt ~ ~4.5 ~
...
# execute as @s[scores={tick=15}] run summon cave_spider ~ ~-2.7 ~ {CustomName:'[{"text":"Sparking Spider","color":"#BAFFFD"}]',Health:60,PersistenceRequired:1b,Tags:["companion","sparking_spider"],DeathLootTable:"empty",Team:DIREWOOD,active_effects:[{id:invisibility,duration:-1,amplifier:0,ambient:1b,show_particles:1b},{id:fire_resistance,duration:-1,amplifier:0,ambient:1b,show_particles:1b}],HandItems:[{id:iron_sword,components:{enchantments:{levels:{"gd_enchantment:lightning_rod":1,unbreaking:10}}},count:1},{}],HandDropChances:[0f,0f],ArmorItems:[{id:netherite_boots,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:netherite_leggings,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:netherite_chestplate,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:netherite_helmet,components:{enchantments:{levels:{unbreaking:10}}},count:1}],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"max_health",base:60f},{id:"minecraft:burn_time",base:0}]}
execute as @s[scores={tick=16}] summon cave_spider run function gd_companion:select/type/sparking_spider/summon
