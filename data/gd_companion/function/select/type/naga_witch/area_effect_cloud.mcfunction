...
# execute as @s[scores={tick=15}] run summon witch ~ ~-2.7 ~ {Team:"DIREWOOD",PersistenceRequired:1b,Health:30f,Tags:["companion","naga"],CustomName:'{"color":"#FF0A8D","italic":false,"text":"Naga the Witch"}',attributes:[{id:"minecraft:armor",base:6},{id:"minecraft:max_health",base:30}]}
execute as @s[scores={tick=16}] summon witch run function gd_companion:select/type/naga_witch/summon
