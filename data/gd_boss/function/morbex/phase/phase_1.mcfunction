...
execute if score @s bossTick matches 10 as @a[tag=fighting.morbex] run function gd_boss:advancement/on_summon/morbex
...
execute if score @s bossTick matches 20 run playsound minecraft:entity.ravager.celebrate master @a[distance=..32] ~ ~ ~ 60 2
...
execute if score @s bossTick matches 18 run playsound minecraft:entity.lightning_bolt.impact master @a[distance=..32] ~ ~ ~ 60 2
...
execute if score @s bossTick matches 26 at @e[type=armor_stand,tag=armorstand.quartz] run playsound minecraft:entity.illusioner.prepare_blindness master @a[distance=..32] ~ ~ ~ 20 1
...
execute if score @s bossTick matches 40 run playsound minecraft:devouring_serpent_morbex record @a[distance=..32] ~ ~1 ~ 50
...
#execute if score @s bossTick matches 200 unless predicate gd_main:weather_thunder_check run weather rain
execute as @p unless predicate gd_main:time_night_check run time add 17
...
execute if score @s bossTick matches 80 run playsound minecraft:entity.lightning_bolt.thunder master @a[distance=..32] ~ ~ ~ 60 2
...
execute if score @s bossTick matches 450 run playsound minecraft:entity.enderman.stare master @a[distance=..32] ~ ~ ~ 60 .1
execute if score @s bossTick matches 500 run playsound minecraft:entity.ravager.roar master @a[distance=..32] ~ ~ ~ 20 0.1
...
execute if score @s bossTick matches 450 at @e[type=minecraft:marker,tag=marker.barrier,distance=..32] run playsound minecraft:entity.illusioner.prepare_blindness master @a[distance=..32] ~ ~ ~ 30 1
...
execute if score @s bossTick matches 600 run playsound minecraft:block.beacon.activate master @a[distance=..32] ~ ~ ~ 20 1
execute if score @s bossTick matches 680 run playsound minecraft:block.beacon.power_select master @a[distance=..32] ~ ~ ~ 20 1
execute if score @s bossTick matches 690..710 run particle minecraft:gust_emitter_large ^ ^1 ^ .2 .2 .2 0.2 1
execute if score @s bossTick matches 695 run playsound minecraft:entity.lightning_bolt.thunder master @a[distance=..32] ~ ~ ~ 60 2
execute if score @s bossTick matches 690 run playsound minecraft:block.bell.use master @a[distance=..32] ~ ~ ~ 20 1
...
execute if score @s bossTick matches 700..710 store result entity @e[limit=1,tag=boss.morbex,sort=nearest] attributes[{id:"minecraft:generic.max_health"}].base int 1 run scoreboard players get morbex.boss.health INT

execute if score @s bossTick matches 710 store result bossbar minecraft:boss.morbex max run scoreboard players get morbex.boss.health INT
execute if score @s bossTick matches 710 store result bossbar minecraft:boss.morbex value run scoreboard players get morbex.boss.health INT
execute if score @s bossTick matches 710 run bossbar set minecraft:boss.morbex players @a[tag=fighting.morbex]

execute if score @s bossTick matches 710 run tag @s add phase_2
execute if score @s bossTick matches 710 run tag @s remove phase_1
execute if score @s bossTick matches 710 run scoreboard players set @s bossTick 0