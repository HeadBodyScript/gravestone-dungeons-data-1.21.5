...
execute as @s[scores={enchantment.poisoning_VFX=6..7}] run function gd_enchantment:poisoning/animation0
execute as @s[scores={enchantment.poisoning_VFX=15..16}] run function gd_enchantment:poisoning/animation0
