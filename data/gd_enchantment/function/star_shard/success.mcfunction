...
scoreboard players set @s enchantment.star_shard.cooldown 240
scoreboard players set @e[type=minecraft:armor_stand,distance=..2,tag=projectile.star_shard] enchantment.star_shard.duration 0
