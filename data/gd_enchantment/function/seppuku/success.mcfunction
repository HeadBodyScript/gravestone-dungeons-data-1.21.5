...
damage @s 18
scoreboard players add @s enchantment.bleeding.count 3
execute as @s[scores={enchantment.bleeding.count=6..}] run function gd_enchantment:bleeding/success
scoreboard players remove @s mana 2000
scoreboard players set @s enchantment.seppuku.cooldown 6000