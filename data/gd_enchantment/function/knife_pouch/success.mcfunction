...
scoreboard players set @s enchantment.knife_pouch.cooldown 60

scoreboard players remove @s enchantment.knife_pouch.count 1
...
execute store result storage damage item double 1 run attribute @s minecraft:attack_damage get
