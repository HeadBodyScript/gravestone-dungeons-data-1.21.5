summon armor_stand ~ ~-.1 ~ {DisabledSlots:4144959,NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["marker.ability_shield","ability","rotate_clockwise"],ArmorItems:[{},{},{},{id:carrot_on_a_stick,components:{custom_model_data:9},count:1}],ArmorDropChances:[0f,0f,0f,0f]}
...
scoreboard players set @s enchantment.retaliation_pulse.count 0
scoreboard players set @s enchantment.retaliation_pulse.duration 0
