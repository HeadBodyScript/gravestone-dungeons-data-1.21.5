scoreboard players add @s enchantment.star_shower.count 1
execute as @e[distance=..2,type=#gd_main:not_fire_res] run function gd_enchantment:star_shower/hit
...
execute if score @s enchantment.star_shower.count matches 300.. run kill @s