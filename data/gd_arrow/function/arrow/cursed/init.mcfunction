...
execute if score .INT randomNumber matches 1..6 at @s[type=!player,tag=arrow_cursed] run summon cod ~ ~ ~ {attributes:[{id:"minecraft:scale",base:2}]} 
execute if score .INT randomNumber matches 7..11 at @s[type=!player,tag=arrow_cursed] run summon salmon ~ ~ ~ {attributes:[{id:"minecraft:scale",base:2}]} 
execute if score .INT randomNumber matches 12..14 at @s[type=!player,tag=arrow_cursed] run summon tropical_fish ~ ~ ~ {attributes:[{id:"minecraft:scale",base:2}]} 
execute if score .INT randomNumber matches 15..16 at @s[type=!player,tag=arrow_cursed] run summon pufferfish ~ ~ ~ {attributes:[{id:"minecraft:scale",base:2}]}
